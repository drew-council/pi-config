...
tucr-review: parse if queue is empty, otherwise resume queue, give option to clear queue with `/tuicr clear` or something so we don't have to always use subcommands
